		...
		Thread t = new Thread(){
			public void run(){
				...
				try {
					...
					shell.printRobotMessage("Connection is established after " + latency + "ms.");
					isConnected = true;
					
					//DM for debug mode, 2 char for specific command in debug like
					//RV for read variable, SM for set mode, SB for set breakpoint
